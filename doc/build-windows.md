...
Below are some notes on how to build Pigeoncoin Core for Windows.
...
way. This will install to `c:\workspace\pigeoncoin`, for example:

    make install DESTDIR=/mnt/c/workspace/pigeoncoin
