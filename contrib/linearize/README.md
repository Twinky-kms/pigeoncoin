# Linearize
Construct a linear, no-fork, best version of the Pigeoncoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install pigeoncoin_hash

https://github.com/pigeoncoin/pigeoncoin_hash
...
JSON-RPC server. Running `pigeoncoind` or `pigeoncoin-qt -server` will be sufficient.
...
* `input`: pigeoncoind blocks/ directory containing blkNNNNN.dat
