...
#ifndef PIGEONCOIN_ARITH_UINT256_H
#define PIGEONCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Pigeoncoin only uses this "compact" format for encoding difficulty
...
#endif // PIGEONCOIN_ARITH_UINT256_H
