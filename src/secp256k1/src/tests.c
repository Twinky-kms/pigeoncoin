...
void test_rand_bits(int rand32, int bits) {
    ...
    static const uint32_t mults[6] = {1, 3, 21, 289, 0x8757, 0x80402011};
...
void run_rand_int(void) {
    static const uint32_t ms[] = {1, 3, 17, 1000, 13771, 875799, 33554432};
...
void run_ecmult_chain(void) {
    ...
    for (i = 0; i < 200*count; i++) {
        ...
        /* verify */
        if (i == 18757) {
            /* expected result after 18757 iterations */
