    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  pigeoncoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Pigeoncoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 PGN, 1 PGN, 10 PGN, 100 PGN and 1000 PGN -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.pigeoncoin.org/en/stable/wallets/pigeoncoincore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
