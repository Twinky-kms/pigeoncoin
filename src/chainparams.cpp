...
public:
    CTestNetParams() {
        ...
        consensus.nMasternodePaymentsStartBlock = 45410; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        consensus.nMasternodePaymentsIncreaseBlock = 45500;
        consensus.nMasternodePaymentsIncreasePeriod = 10;
        consensus.nInstantSendConfirmationsRequired = 2;
        consensus.nInstantSendKeepLock = 6;
        consensus.nBudgetPaymentsStartBlock = 46000;
        consensus.nBudgetPaymentsCycleBlocks = 50;
        consensus.nBudgetPaymentsWindowBlocks = 10;
        consensus.nSuperblockStartBlock = 46500; // NOTE: Should satisfy nSuperblockStartBlock > nBudgetPaymentsStartBlock
        ...
        consensus.BIP65Height = 1;
        consensus.BIP66Height = 1;
        consensus.DIP0001Height = 45410;
        consensus.DIP0003Height = 45500;
        consensus.DIP0003EnforcementHeight = 45500;
        consensus.DIP0003EnforcementHash = uint256S("0x00");
