...
#error Client version information missing: version is not defined by pigeoncoin-config.h or in any other way
#endif
...
/**
 * pigeoncoind-res.rc includes this file, but it cannot cope with real c++ code.
